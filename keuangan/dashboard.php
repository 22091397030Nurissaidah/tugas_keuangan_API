...
<head>
    ...
    <link rel="shortcut icon" href="img/iconn.png">
    <title>Dompet Maniezz - Dashboard</title>
...
<body>
    <div class="header">
        <img src="img/iconn.png" width="25px" height="25px" class="float-left logo-fav">
        <h3 class="text-secondary font-weight-bold float-left logo">Dompet</h3>
        <h3 class="text-secondary float-left logo2">Maniezz</h3>
        <a href="logout">
            <div class="logout">
            ...
            <ul>
                ...
                <li class="klik2" id="flip2" style="cursor:pointer;">
                    <div>
                        ...
                        <i class="fas fa-caret-right float-right" style="line-height: 15px;"></i>
                    </div>
                </li>
                ...
                <div class="container" id="container" style="border: none;">
                    <div class="row tampilCardview" id="row">
                        ...
                        <div class="col-md-4 jarak">
                            <div class="card card-stats card-warning" style="background: #1679AB;">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
